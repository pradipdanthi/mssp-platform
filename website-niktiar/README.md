...
```bash
# Start / recreate
/opt/mssp-control/website-niktiar/lab-serve.sh

# Status
docker ps --filter name=niktiar-website-lab
```
...
Optional systemd unit file is also present (`niktiar-website-lab.service`) if you prefer host nginx later.
