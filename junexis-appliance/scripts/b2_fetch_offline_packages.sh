...
OUT="${JUNEXIS_OFFLINE_PACKAGES:-$ROOT/iso/offline-packages}"
BIN_OUT="$OUT/bin"
WHEEL_OUT="$OUT/wheels"
MANIFEST="$OUT/MANIFEST.txt"
IMAGE="${JUNEXIS_OFFLINE_FETCH_IMAGE:-ubuntu:24.04}"
WAZUH_PKG_VER="${JUNEXIS_WAZUH_MANAGER_DEB_VERSION:-4.14.6-1}"
NUCLEI_VER="${JUNEXIS_NUCLEI_VERSION:-3.11.0}"
VULS_VER="${JUNEXIS_VULS_VERSION:-0.40.1}"
ZEEK_VER="${JUNEXIS_ZEEK_DEB_VERSION:-8.0.9-0}"
...
(
  cd "$OUT"
  {
    echo "# Junexis appliance offline catalogue engines"
