...
class TelemetryForwarder:
    """
    Strip PII and POST normalized alerts to api.junexis.com telemetry ingest.
    ...
    def __init__(
        ...
        *,
        ...
        self.appliance_id = appliance_id or os.environ.get("JUNEXIS_APPLIANCE_ID", "")
        self.api_key = api_key or os.environ.get("JUNEXIS_APPLIANCE_API_KEY", "")
