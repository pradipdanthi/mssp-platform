...
Status: **Active**  
Date: 2026-08-05  
Depends on: Tracks 1–4 + KB-093L (VM 114 Appliance Management)
...
| **5.3** | First VM/ISO appliance boots to register | Lab appliance (or rebuild ISO once) runs the copied register command and appears Online |
