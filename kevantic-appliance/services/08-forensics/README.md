# svc-08 Forensics — FIM/deception listener glue

Modular Kevantic appliance service. Enabled only when entitlement includes `svc-08` (except core SKU rules for svc-01).
